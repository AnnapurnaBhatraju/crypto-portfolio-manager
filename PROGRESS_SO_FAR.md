...
Cleaned default boilerplate files for a fresh start.
...
Prevented default form submission refresh.

Set up structure to display error or success messages.

✔ Project Cleanup & Optimization

Organized components inside a dedicated components folder.

Added a styles.css file for layout and basic UI design.

Ensured clean and readable JSX structure.
